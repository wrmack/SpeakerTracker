//
//  DisplayMeetingGroupsHeaderView.swift
//  SpeakerTracker
//
...
class DisplayMeetingGroupsHeaderView: UITableViewHeaderFooterView {
    ...
    private func setupViews() {
        ...
        entityButton!.addTarget(nil, action: #selector(DisplayMeetingGroupsViewController.entityButtonPressed(_:)),  for: .touchUpInside)
