...
class InfoViewController: UIViewController {
   ...
   override func viewDidLoad() {
      ...
      let heading1Attributes = [NSFontAttributeName : UIFont(name: "Arial-BoldMT", size: 20)!,
                               NSForegroundColorAttributeName : UIColor.black,
                               NSParagraphStyleAttributeName: leftStyle] as [String : Any]
      let heading2Attributes = [NSFontAttributeName : UIFont(name: "Arial-BoldMT", size: 18)!,
                                NSForegroundColorAttributeName : UIColor.black,
                                NSParagraphStyleAttributeName: leftStyle] as [String : Any]
      let normalAttributes = [NSFontAttributeName : UIFont(name: "Arial", size: 14)!,
                              NSForegroundColorAttributeName : UIColor.black,
                              NSParagraphStyleAttributeName: leftStyle] as [String : Any]
      let normalBoldAttributes = [NSFontAttributeName : UIFont(name: "Arial-BoldMT", size: 14)!,
                              NSForegroundColorAttributeName : UIColor.black] as [String : Any]
      let centeredAttributes = [NSParagraphStyleAttributeName: centeredStyle]
