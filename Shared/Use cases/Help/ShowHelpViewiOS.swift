        ...
        ScrollView {
            VStack(alignment: .leading) {
                ...
                Group {
                    ...
                    Text(
                        """
                        Either swipe the member name or press the arrow. A member in the Speaking List \
                    ...
                    Text(
                        ...
                        speaker who has already spoken once, long-press on the speaker and select the menu option to speak again.
                        """
                    )
                    Text("**Amendments**")
                    Text(
                ...
                Group {
                    ...
                    Text(
                        ...
                        When the meeting event is over, save the final debate and, in the slide-out panel, turn off the switch \
                        'Create a record of this meeting'.
                        """
                    )
                    Text("Setup")
                        .font(.title)
...
struct ShowHelpViewiOS_Previews: PreviewProvider {
